            ...
            case 'edit_comment':
                {
                    ...
                    const response = await fetch(`http://localhost:4040/cmtse`, {
                        method: 'POST',
            ...
            case 'create_comment':
                {
                    ...
                    const response = await fetch(`http://localhost:4040/cmtsc`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            ...
            case 'remove_comment':
                {
                    ...
                    const response = await fetch(`http://localhost:4040/cmtsd`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
...
async function fetchComentarios() {
    try {
        const response = await fetch(`http://localhost:4040/cmtsr?op=${props.qstDb}&id=${props.questionId}`)
